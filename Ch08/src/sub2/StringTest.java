...
public class StringTest {
	public static void main(String[] args) {
		...
		if (str1 == str2) {
			System.out.println("str1 주소와 str2가 같다.");
		} else {
			System.out.println("str1 주소와 str2가 다르다.");
		}

		if (str1.equals(str2)) {
			System.out.println("str1 문자열과 str2 문자열이 같다.");
		} else {
			System.out.println("str1 문자열과 str2 문자열이 ekfmek..");
		}
		// 문자열 길이
		...
		System.out.println("sample 앞에서 부터 e 인덱스 : " + sample.indexOf("e"));
		System.out.println("sample 뒤에서 부터 e 인덱스 : " + sample.lastIndexOf("e"));
		// 문자열 교체
